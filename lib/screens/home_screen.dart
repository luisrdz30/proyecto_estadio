...
import '../theme_manager.dart'; // 👈 controlador global del modo oscuro
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    // 🧠 Escucha el tema global sin cerrar el Drawer
          ...
          child: Scaffold(
                ...
                children: [
                  ...
                  SwitchListTile(
                    ...
                    onChanged: (value) {
                      ...
                      // 🧠 Nuevo: evita cerrar el Drawer manteniendo el foco en pantalla
                      Future.delayed(const Duration(milliseconds: 150), () {
                        setState(() {}); // fuerza solo un rebuild local
                      });

                      // ✨ NUEVO: sincroniza todas las pantallas en segundo plano
            ...
            body: StreamBuilder<List<Event>>(
              ...
              builder: (context, snapshot) {
                ...
                final totalPages =
                    (filteredEvents.length / _eventsPerPage).ceil();
